...
# SSH download link, see https://www.mls-software.com/opensshd.html
$ssh_download_url = "https://www.mls-software.com/files/setupssh-8.5p1-1.exe"
$ssh_download_hash = "b280544abbfa5725486d5e3de6bc26c53cbf17d9"

if (!(Test-Path "C:\Program Files\OpenSSH\bin\ssh.exe")) {
    Write-Output "Downloading $ssh_download_url"
    $WebClient = New-Object System.Net.WebClient
    $WebClient.DownloadFile($ssh_download_url, "C:\Windows\Temp\openssh.exe")

    $FileHash = Get-FileHash -Algorithm SHA1 "C:\Windows\Temp\openssh.exe"

    if ($FileHash.Hash -ne $ssh_download_hash) {
        throw "Installer hash does not match."
    }
